...
A definition is the steps that the workflow will execute a list of steps that will be executed in order. Each step has a name, type, and configuration. Each step in the workflow has access to the outputs of the previous steps and can reference them, alongside the input variables.
